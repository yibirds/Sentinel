 ...
 */
package com.alibaba.csp.sentinel.dashboard.controller.old;
 ...
 */
//@RestController
@RequestMapping(value = "/authority/old")
public class AuthorityRuleControllerOld {

    private final Logger logger = LoggerFactory.getLogger(AuthorityRuleControllerOld.class);
